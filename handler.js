...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Perintah ini hanya khusus digunakan oleh _*OWNER*_',
    owner: 'Perintah ini hanya khusus digunakan oleh _*Owner Bot*_!',
    mods: 'Perintah ini hanya khusus digunakan oleh _*Moderator*_ !',
    premium: 'Perintah ini hanya untuk member _*Premium*_ !',
    group: 'Perintah ini hanya khusus digunakan di grup!',
    private: 'Perintah ini hanya khusus digunakan di Chat Pribadi!',
    admin: 'Perintah ini hanya untuk *Admin* grup!',
    botAdmin: 'Jadikan bot sebagai *Admin* untuk menggunakan perintah ini!',
    unreg: 'Silahkan daftar untuk menggunakan Bot ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar KamiKaze.17*'
  }[type]
